...
const columns = [
        ...
        {
            name: 'ACTION',
            selector: row => <button onClick={()=>navigate(`/order/${row._id}`)} style={{background:"rgb(235, 141, 53)",padding:"5px",borderRadius:"8px",color:"black",border:"none"}}>details</button>,
            center:true
        },
    ];
